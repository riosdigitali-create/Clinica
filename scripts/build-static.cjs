...
for(const file of ['app.js','admin.js','admin-login.js','catalog.js','commerce.js','study-knowledge.js','chatbot.js'])fs.copyFileSync(file,'dist/client/'+file);
...
fs.copyFileSync('_headers','dist/client/_headers');
console.log('Sitio estático listo para Cloudflare Pages. No hay pagos reales ni envíos externos habilitados.');
